      ...
      <main class="mdl-layout__content">
        ...
        <div class="mdl-grid">
          ...
          <div class="mdl-cell mdl-cell--8-col mainContent">
            ...
            <h2>I'm under attack!</h2>

            <img class="generic-images" src="./images/funny-scared-cats-compilation.jpg" />
                ...
                <div class="mdl-card__supporting-text">
                  <?php 
                    ...
                    if ($action=="")    /* display the contact form */ 
                        ...
                        <button  onclick="badCookie()" class="mdl-button mdl-js-button mdl-button--raised" type="submit">
                          Submit
                        </button>
                        ...
                        <script type="text/javascript">
                          function badCookie() {
                            document.cookie = "BadToken=doesntwork;max-age=600";  
                          }
                        </script>
